...
import CartesEvenements from "../assets/French printable game/FRENCH-NATIONAL_GAME/FRANCE_CARTES_EVENEMENTS.pdf";
import CartesSpeciales from "../assets/French printable game/FRENCH-NATIONAL_GAME/FRANCE_CARTES_SPECIALES.pdf";
import JeuNationalCartes from "../assets/French printable game/FRENCH-NATIONAL_GAME/FRANCE_JEU_NATIONAL_CARTES.pdf";
import JeuNationalIles from "../assets/French printable game/FRENCH-NATIONAL_GAME/FRANCE_JEU_NATIONAL_ILES.pdf";
import JeuNationalResources from "../assets/French printable game/FRENCH-NATIONAL_GAME/FRANCE_JEU_NATIONAL_RESSOURCES_ENSEIGNANTS.pdf";
import Regles from "../assets/French printable game/FRENCH-NATIONAL_GAME/FRANCE_REGLES DU JEU.pdf";
